...
詳細は公式クイックスタート: `docs/quickstart.md`
...
対応パッケージ一覧は `README.md` の Install セクションと `docs/PACKAGE-FEATURE-MATRIX.md` を参照してください。
...
4. `docs/tutorials/`
5. `docs/compliance/owasp-agentic-top10-architecture.md`
